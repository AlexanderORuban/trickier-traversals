...
public class Traversals {
  ...
  public static int sumLeafNodes(TreeNode<Integer> node) {
    ...
    return sum + sumLeafNodes(node.left) + sumLeafNodes(node.right);
  }
  ...
  public static int countInternalNodes(TreeNode<Integer> node) {
    ...
    return sum + countInternalNodes(node.left) + countInternalNodes(node.right);
  }
  ...
  public static <T> String buildPostOrderString(TreeNode<T> node) {
    ...
    stringBuilder.append(buildPostOrderString(node.left));
    stringBuilder.append(buildPostOrderString(node.right));
  ...
  public static int countDistinctValues(TreeNode<Integer> node) {
    ...
    return countDistinctValuesHelper(node, set);
  }

  public static int countDistinctValuesHelper(TreeNode<Integer> node, Set<Integer> set) {
    if (node == null) return 0;
    ...
    count += countDistinctValuesHelper(node.left, set) + countDistinctValuesHelper(node.right, set);
  ...
  public static boolean hasStrictlyIncreasingPath(TreeNode<Integer> node) {
    ...
    if (node.left != null && node.left.value > node.value) left = hasStrictlyIncreasingPath(node.left);
    if (node.right != null && node.right.value > node.value) right = hasStrictlyIncreasingPath(node.right);
